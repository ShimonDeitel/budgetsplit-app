...
/// Tripside Budget Split theme: unique palette for this app's domain, distinct from other apps in the portfolio.
enum Theme {
    static let accent = Color(red: 0.1059, green: 0.6000, blue: 0.5451)
    static let background = Color(red: 0.0392, green: 0.0863, blue: 0.0824)
    static let cardBackground = Color(red: 0.0992, green: 0.1463, blue: 0.1424)
