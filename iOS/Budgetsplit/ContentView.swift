...
struct ContentView: View {
    ...
    @State private var editingEntry: BudgetsplitEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Tripside Budget Split")
            .toolbar {
...
struct EntryEditorView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(entry == nil ? "Add Trip" : "Edit Trip")
            .toolbar {
