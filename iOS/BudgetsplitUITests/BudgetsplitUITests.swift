...
final class BudgetsplitUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() {
        ...
        XCTAssertTrue(app.buttons["purchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Tripside Budget Split Pro"].waitForExistence(timeout: 3))
    }
